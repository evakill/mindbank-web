...
function (_React$Component) {
  ...
  return Links;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component); // <div className="tile is-child notification has-text-white has-text-left" style={{backgroundColor: "#00396d", borderRadius: 4}}>
//   <p className="title is-size-2" style={{color: "#e5e5e5"}}>Our Value</p>
...
// </div>
//
//   <div className="tile is-child notification has-text-white has-text-right" style={{backgroundColor: "#00396d", borderRadius: 4}}>
//     <p className="title is-size-2" style={{color: "#e5e5e5"}}>Experiential Learning</p>
...
//   </div>
// <div className="column" style={{backgroundColor: "#fff", margin: 10, borderRadius: 10}}>
//   <Square
...
//         <p className="title is-size-2">Contact</p>
//         <p className="subtitle">Please reach out with any inquiries.</p>
...
//# sourceMappingURL=index.js.b556659c3340d9b3cc92.hot-update.js.map