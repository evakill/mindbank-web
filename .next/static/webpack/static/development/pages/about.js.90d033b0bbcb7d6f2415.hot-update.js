...
var About = function About() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: this
  }, " The MindBank is the result of the frustrations a student felt when working on a startup at the University of Pennsylvania. Whenever he asked for feedback or advice from industry leaders, he would get contradictory opinions making any decision even more confusing. At the core of The MindBank\u2019s founding goal was to provide a place where these contrasting opinions could be raised in dialogue together, in the hope this would result in a clearer path forward for the many startups that seek advice.", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40
    },
    ...
    __self: this
  }), "To this day, that starting principle remains steadfast. The MindBank does not have one culture, one worldview or one opinion - it has countless. This serves to make sure that every problem is assessed from all perspectives and results in insights from our team that can only arise when people disagree and challenge each other in this way, forming an ultimately clearer path informed by each viewpoint.", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43
    },
    ...
    __self: this
  }), "Today, The MindBank works with both groups that have a physical presence on campuses as well as business that target millienials more broadly.... ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
    style: {
      paddingTop: '2rem'
    },
    __source: {
...
//# sourceMappingURL=about.js.90d033b0bbcb7d6f2415.hot-update.js.map