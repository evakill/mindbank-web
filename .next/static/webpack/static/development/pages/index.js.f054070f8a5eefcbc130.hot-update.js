...
var InfoBox = function InfoBox() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    pose: _this.state.hAbout ? "hovered" : "idle",
...
function (_React$Component) {
  ...
  function Links(props) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Links).call(this, props));
    _this2.state = {
      hAbout: false,
      hClient: false,
      hConsult: false,
...
function (_React$Component2) {
  ...
  function News(props) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(News).call(this, props));
    _this4.state = {
...
//# sourceMappingURL=index.js.f054070f8a5eefcbc130.hot-update.js.map