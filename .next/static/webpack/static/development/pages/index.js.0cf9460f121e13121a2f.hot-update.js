...
var Links = function Links() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    pose: _this2.state.hAbout ? "hovered" : "idle",
    ...
    pose: _this2.state.hClient ? "hovered" : "idle",
    onMouseEnter: function onMouseEnter() {
      return _this2.setState({
        hClient: true
      });
    ...
    pose: _this2.state.hConsult ? "hovered" : "idle",
    onMouseEnter: function onMouseEnter() {
      return _this2.setState({
        hConsult: true
      });
...
//# sourceMappingURL=index.js.0cf9460f121e13121a2f.hot-update.js.map