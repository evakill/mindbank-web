...
class News extends React.Component {
  ...
  render() {
    return (
      <section>
      <Header/>
      <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", paddingTop: 80, margin: "0 3%"}}>
        ...
        <div className="columns" style={{paddingBottom: "5%"}}>
          <div className="column is-one-fifth-fullhd"></div>
